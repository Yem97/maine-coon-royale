  ...
  return (
    <div className="max-w-2xl">
      <div className="mb-8">
        ...
        <p className="text-gray-500 text-sm mt-1">Update your cattery information — changes appear instantly on the website.</p>
      </div>
      ...
      <div className="glass rounded-2xl border border-gold/20 p-8 space-y-6">
        ...
        <div className="flex items-center gap-6">
          ...
          <div>
            ...
            <p className="text-gray-500 text-xs mb-3">This photo appears on your About section.</p>
        ...
        <div className="border-t border-white/5 pt-6 space-y-4">
          ...
          <div><label className={lbl}>Kittens Placed / Happy Families</label><input type="number" min={0} value={profile.kittens_placed} onChange={e => set('kittens_placed', Number(e.target.value))} className={inp} /></div>
        </div>

        <div className="border-t border-white/5 pt-6 space-y-4">
          <p className="text-xs text-gray-400 uppercase tracking-wide font-medium">Contact & Social Links</p>
          <div className="grid grid-cols-2 gap-4">
            ...
            <div><label className={lbl}>WhatsApp Number</label><input value={profile.whatsapp || ''} onChange={e => set('whatsapp', e.target.value)} placeholder="+1 555 000 0000" className={inp} /></div>
          </div>
        ...
        <div className="flex items-center gap-4 pt-2">
          ...
          {saved && <div className="flex items-center gap-2 text-emerald-400 text-sm"><CheckCircle size={16} />Saved successfully!</div>}
        </div>
      </div>
    </div>
  );
